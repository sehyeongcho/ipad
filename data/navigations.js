/**
 * Footer 섹션에 표시되는 각 메뉴의 데이터는 구조가 동일하고, 메뉴가 추가되거나 삭제될 수 있습니다.
 * 따라서 코드의 반복을 줄이고, 메뉴가 추가되거나 삭제될 때마다 HTML, CSS를 추가하거나 삭제해야 하는 번거로움을 줄이기 위해 각 메뉴의 데이터를 객체화하여 배열로 관리합니다.
 */
